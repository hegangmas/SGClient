...
-(void)loadSVG{
    ...
    offsetY_ = (offsetY_ < MainScreenHeight(self.interfaceOrientation)) ? MainScreenHeight(self.interfaceOrientation) : offsetY_ ;
    self.width = (self.width < MainScreenWidth(self.interfaceOrientation)?MainScreenWidth(self.interfaceOrientation):self.width);
